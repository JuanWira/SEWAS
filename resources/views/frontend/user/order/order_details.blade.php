        ...
        <div class="sign-in-page" style="margin: 30px 0">
                    ...
                    <div class="media product-card">
                        ...
                        <div class="media-body">
                            @if ($order->status != 'selesai')
                                ...
                                <p style="font-size: 14px">Dari : {{ $item->tanggal_peminjaman }}
                            
                                </p>
                                <p style="font-size: 14px">Sampai : {{ $item->tanggal_pengembalian }}
                            
                                <br>    <br>
                            </p>
                                <p style="font-size: 14px">Harga Sewa : Rp{{ number_format($item->price, 0, ',', '.') }} 
                                </p>
                            ...
                            @else
                                ...
                                <p style="font-size: 14px">Sampai : {{ $item->tanggal_pengembalian }}
                                <p style="font-size: 14px">Harga Sewa :
                        ...
                        <div class="col-md-8">
                            ...
                            <p style="margin-bottom: 10px;">
                                <span style="checkout-btn">
                                    <strong style="font-size: 16px">Total Sewa</strong>
                                </span>
                                <span class="">
                                    <strong
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <span class="badge badge-pill badge-warning" style="background: red">Kurir kami akan segera mengambil barang yang anda sewa </span>
